 ...
 * </ul>
 */
public class OldTreeVisual {
    private OldTree.Node<String> node;
    ...
    private Map<String, OldTree.PositionedNode<String>> allNodesPositions;
    private ConcurrentHashMap<Integer, Integer> tempList;
    private  OldTree tree;
    ...
    /**
     * <b>Note: </b> Create an instance of the search tree from a {@link org.uclouvain.visualsearchtree.tree.OldTree.Node Node} object.
     * @param node
     */
    public OldTreeVisual(OldTree.Node<String> node) {
        this.node = node;
    ...
    /**
     * Create an instance of the search without {@link org.uclouvain.visualsearchtree.tree.OldTree.Node Node} object pass argument.
     * <br/><br/>
     * <p>
     *     <b>Use case: </b> Used for  Realtime constructor
     * </p>
     */
    public OldTreeVisual(){
        initTreeVisual();
    }
     ...
     * @return {@link org.uclouvain.visualsearchtree.tree.OldTree.Node Node}
     */
    public OldTree.Node<String> getNode() {
        return node;
    }

    /**
     * <b>Notes: </b> Get the list of label defined on each {@link org.uclouvain.visualsearchtree.tree.OldTree.Node Node} of Search {@link org.uclouvain.visualsearchtree.tree.OldTree}
    ...
    /**
     * <b>Note: </b> Define nookmark on specific {@link org.uclouvain.visualsearchtree.tree.OldTree.Node Node}
     * @param key
     * @param value
     */
    ...
    /**
     * <b>Note: </b> Focus on a Tree {@link org.uclouvain.visualsearchtree.tree.OldTree.Node Node}
     * @param r
     * @param type
     * @param label
     * @param nodeId
     */
    public void setFocusedRect(Rectangle r, OldTree.NodeType type, Text label, int nodeId) {
    ...
    public Map<String, OldTree.PositionedNode<String>> getAllNodesPositions() {return allNodesPositions;}

    /**
     * <b>Note: </b> Use {@link org.uclouvain.visualsearchtree.tree.OldTree.PositionedNode PositionedNode} to build tree and return it as {@link javafx.scene.Group Group}
     * @return {@link javafx.scene.Group}
     */
    public Group getGroup() {
        Group root = new Group();
        OldTree.PositionedNode<String> pnode = this.getNode().design();
     ...
     */
    public  Rectangle drawNodeRecur(Group g, OldTree.PositionedNode<String> root, double center, int depth, Text nLabel) {
        ...
        for (OldTree.PositionedNode<String> child : root.children) {
     ...
     */
    private Rectangle createRectangle(double x, double y, OldTree.NodeType type, int id) {
     ...
     */
    private Rectangle createRectangleForLegendBox(OldTree.NodeType type) {
    ...
    public HBox generateLegendsStack(){
        ...
        Rectangle branchRect = createRectangleForLegendBox(OldTree.NodeType.INNER);
        Rectangle solvedRect = createRectangleForLegendBox(OldTree.NodeType.SOLUTION);
        Rectangle failedRect = createRectangleForLegendBox(OldTree.NodeType.FAIL);
    ...
    public void makeNotFocus(){
        ...
        var branch = (OldTree.NodeType) this.focusedRect.get(1);
    ...
    public LineChart<Number, Number> getTreeChart(boolean all_sol){
        ...
        if (all_sol)
        {
            ...
            {
                if (this.allNodesPositions.get(key).type == OldTree.NodeType.SOLUTION)
                {
     ...
     * @param info
     */
    public void createNode(int id, int pId, OldTree.NodeType type, NodeAction onClick, String info){
        Platform.runLater(()->{
